---
description: Tìm hiểu về các toán tử quan hệ/so sánh trong Python
...
### Chú ý: các bạn mới lập trình hay nhầm lẫn phép so sánh bằng, để so sánh bằng phải dùng <mark style="color:red;">HAI (2) dấu bằng ( = )</mark>. Một dấu bằng được dùng để gán.
...
{% embed url="https://youtu.be/T9cO0nm4b-Q" %}
