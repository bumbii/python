...
* Đây là phần rất quan trọng! Để đặt tên biến, bạn cần tuân theo các quy tắc sau:
  ...
  2. Tên biến chỉ được chứa chữ cái, chữ số và dấu gạch dưới, các ký tự đặc biệt không được dùng (ví dụ: dấu sao <mark style="color:red;">`*`</mark> , dấu gạch ngang <mark style="color:$danger;">`-`</mark>, dấu <mark style="color:red;">`#`</mark>).
...
{% embed url="https://youtu.be/SGn5AqvHAQA" %}
