...
const styles = {
  ...
  levelBadge: (level: string) => ({
    ...
    backgroundColor: level === 'easy' ? M3.colors.success : level === 'medium' ? M3.colors.warning : M3.colors.error,
  ...
  progressFill: {
    height: '100%',
    background: `linear-gradient(90deg, ${M3.colors.secondary} 0%, #f5576c 100%)`,
  ...
  actionButton: {
    padding: `${M3.spacing.lg} ${M3.spacing['4xl']}`,
    ...M3.typography.titleLarge,
    fontWeight: '700',
    color: M3.colors.onPrimary,
    border: 'none',
